...
exports.extractYtcfgConfig = void 0;
 ...
 * @internal
 */
function extractYtcfgConfig(html) {
        ...
        if (braceStart !== -1
            ...
            if (raw != null) {
                try {
                    ...
                    throw new index_js_1.IllegalStateError('ytcfg config parse failed');
                }
            }
        }
...
exports.extractYtcfgConfig = extractYtcfgConfig;
